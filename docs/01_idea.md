...
Core boundaries:
- Off-grid microgrid (not grid-tied)
- Commercial and industrial customers (not residential)
- Configuration and sizing (not O&M monitoring)
- Economic analysis (not electrical design)
